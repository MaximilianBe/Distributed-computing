...
public class IncDecThreads extends Thread {
  // Maximim fr die Iteration
  public static final long MAX = 10000000;
  // Um die folgende Gre weiterschalten
  ...
  // Dies ist der Zhler, der von diversen Threads
  // bearbeitet wird.
  ...
  // Einfach rauf oder runter zhlen...
  public void demo () {
  ...
  //No Synchronisation of zaehler variable
  public synchronized void demoSynchOne (){
    for (long i = 0; i < MAX; i++) {
      zaehler = zaehler + increment;
    }
  }

  public void demoSynchTwo (){
    for (long i = 0; i < MAX; i++) {
  ...
  public void run() {
    //demoUnSync ();  // Unsynchronisiertes Zhlen
    //demoSync ();  // Synchronisiertes Zhlen
    demoSynchTwo();
  }
}
